...
def main(path, pixelsize, mode, outfolder):
	I2H = Image2HTML(path, pixelsize, outfolder)
	if mode == 'copy':
		I2H.Get()
	elif mode == 'save':
		I2H.Save()
...
if __name__ == '__main__':
	analyser = argparse.ArgumentParser(description='Script for convert images to HTML...Simple.')
	...
	main(prms.image, prms.pixelsize, prms.mode, prms.folder)